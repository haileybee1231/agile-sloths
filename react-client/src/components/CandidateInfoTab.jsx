...
class ConnectedCandidateInfoTab extends React.Component {
  ...
  componentWillMount() {
    this.fetchCandidateInfo(this.props.saveCandidateInfo, window.localStorage.zipCode || '78701') // defaults to a local Austin zip, can be refactored to take logged in user's zip
  }
